...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _resetPassword() async {
    String email = _emailController.text.trim();
    if (email.isNotEmpty) {
      bool success = await _authServices.resetPassword(email);
      String message = success ? "Reset email sent!" : "Failed to send email.";
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: screenWidth / 5.83),
                ...
                GestureDetector(
                  ...
                  child: Text(
                    "Forgot Password?",
                    style: TextStyle(color: Colors.blue, fontSize: screenWidth / 31.84),
                  ),
                ),
                ...
                GestureDetector(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        "Register",
                        style: TextStyle(fontSize: screenWidth / 31.84, color: Colors.blue),
                      ),
                    ],
                  ),
                ),
